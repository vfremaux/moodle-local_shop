...
class shop_handler_std_enrolonecoursemultiple extends shop_handler {
    ...
    public function produce_postpay(&$data) {
        ...
        $fb = get_string('productiondata_assign_public', 'shophandlers_std_enrolonecoursemultiple');
        $productionfeedback->public = $fb;
        $fb = get_string('productiondata_assign_private', 'shophandlers_std_enrolonecoursemultiple', $course->id);
        $productionfeedback->private = $fb;
        $fb = get_string('productiondata_assign_sales', 'shophandlers_std_enrolonecoursemultiple', $course->id);
        $productionfeedback->salesadmin = $fb;
