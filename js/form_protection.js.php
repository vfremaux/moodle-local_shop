   ...
   for (i = 0 ; i < textfield.value.length; i++) {
       switch (cap_state) {
           case 0 : { // not word char
               ...
               elseif (textfield.value.charAt(i) == 'é') {
                fieldvalue += "E";
                }
            elseif (textfield.value.charAt(i) == 'è')
                {
                fieldvalue += "E";
                }
            elseif (textfield.value.charAt(i) == 'ê')
                {
                fieldvalue += "E";
                }
            elseif (textfield.value.charAt(i) == 'à')
                {
                fieldvalue += "A";
                }
            else
        ...
        case 1 : // first word char
            ...
            elseif ((textfield.value.charAt(i) == 'é') || (textfield.value.charAt(i) == 'è') || (textfield.value.charAt(i) == 'ê') || (textfield.value.charAt(i) == 'à') || (textfield.value.charAt(i) == 'ù') || (textfield.value.charAt(i) == 'ç') || (textfield.value.charAt(i) == 'ô') || (textfield.value.charAt(i) == 'û') || (textfield.value.charAt(i) == 'î'))
                {
                fieldvalue += textfield.value.charAt(i);
                }
            else
