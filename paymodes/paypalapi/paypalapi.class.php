...
class shop_paymode_paypalapi extends shop_paymode {
    ...
    */ 
        ...
        if ($rawresponse) {
            if ($rawresponse == 'VERIFIED') {
                ...
                if ($aFullBill->status != 'SOLDOUT') {
                    ...
                    $cmd = '';
                    include($CFG->dirroot.'/local/shop/front/success.controller.php');
                }
    ...
    function settings(&$settings) {
        ...
        $settings->add(new admin_setting_configtext('local_shop_paypalsellertestname', get_string('paypalsellertestname', 'shoppaymodes_paypal'),
                           get_string('configpaypalsellername', 'shoppaymodes_paypal'), '', PARAM_TEXT));

        $settings->add(new admin_setting_configtext('local_shop_sellertestitemname', get_string('sellertestitemname', 'shoppaymodes_paypal'),
                           get_string('configselleritemname', 'shoppaymodes_paypal'), '', PARAM_TEXT));

        $settings->add(new admin_setting_configtext('local_shop_paypalsellername', get_string('paypalsellername', 'shoppaymodes_paypal'),
                           get_string('configpaypalsellername', 'shoppaymodes_paypal'), '', PARAM_TEXT));

        $settings->add(new admin_setting_configtext('local_shop_selleritemname', get_string('selleritemname', 'shoppaymodes_paypal'),
                           get_string('configselleritemname', 'shoppaymodes_paypal'), '', PARAM_TEXT));
    }
}