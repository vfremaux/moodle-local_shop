...
// Privacy.
$string['privacy:metadata'] = 'Le composant Gestionaire d\'achat Ogone ne détient directement aucune donnée relative
aux utilisateurs.';
...
$string['configsecretin'] = 'Cette clef secrète encode les données que vous envoyez à la passerelle. Elle doit être identique
à celle définie dans votre compte marchand.';
$string['secretout'] = 'Clef secrète de vérification des données sortantes de passerelle';
$string['configsecretout'] = 'Cette clef secrète vous permet de vérifier les réponses que vous revcevez de passerelle. Elle doit
être identique à celle définie dans votre compte marchand.';
$string['paramvar'] = 'Clef de routage multiboutiques';
$string['configparamvar'] = 'Cette clef permet à Ogone de router différement le retour du processus d\'achat (Optionnel - Voir
la documentation Ingénico/Ogone)';
$string['logourl'] = 'URL de logo de la page de paiement';
$string['configlogourl'] = 'URL de logo personnalisé sur la page de paiement distante (Elle doit être une URL HTTPS, car les
interfaces d\'Ogone sont sécurisées)';
...
courriel dans votre boite de réception, 
