...
class shop_paymode_systempay extends shop_paymode {
    ...
    function print_payment_portlet(&$shoppingcart) {
        ...
        $portlet->merchant_id = $config->systempay_merchant_id;
    ...
    */
    ...
    function settings(&$settings) {
        ...
        $bankoptions = array('ce' => 'Caisse d\'Epargne', 'bp' => 'Banque Populaire');
    ...
    function generate_online_id() {
        ...
        $onlinetxid = sprintf('%06d', ++$config->systempay_idseq);
