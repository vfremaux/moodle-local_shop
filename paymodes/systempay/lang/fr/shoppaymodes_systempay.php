...
// Privacy.
$string['privacy:metadata'] = 'Le composant Gestionaire d\'achat SystemPay ne détient directement aucune donnée relative aux utilisateurs.';
...
$string['configsystempayuselocaltime'] = 'Si coché, utilise l\'heure locale du serveur pour dater les transations, sinon prend l\'heure GMT.';
...
$string['enablesystempay2'] = 'Cartes de crédit (System Pay), un service de la <img valign="top" src="'.$CFG->wwwroot.'/local/shop/paymodes/systempay/pix/logo_{$a->systempay_bank}.png" />'; // Shop GUI.
...
<p>Votre paiement a été confirmé par notre service de paiement (systemPay Plus). Nous avons procédé à la mise en oeuvre de vos produits.</p>
