...
<li><b>Déclencheur IPN sans terminaison</b> : Ceci simule l\'activation du traitement de retour d\'IPN dans une fenêtre séparée. Vous pouvez lancer ce lien avant même l\'émission du paiement, la situation alors simulée est celle
d\'un service bancaire réactif qui valide le paiement avant que le client ne retourne à la boutique. La commande est complètement traitée dans ce cas. Avec cette action, la commande reste non traitée pour pouvoir être relancée plusieurs fois.</li>
<li><b>Déclencheur IPN avec terminaison</b> : Ceci simule l\'activation du traitement de retour d\'IPN dans une fenêtre séparée. Vous pouvez lancer ce lien avant même l\'émission du paiement, la situation alors simulée est celle
d\'un service bancaire réactif qui valide le paiement avant que le client ne retourne à la boutique. La commande est complètement traitée dans ce cas.</li>
</ul>
';

$string['pending_followup_text_tpl'] = '
<p>Votre commande est en attente d\'une confirmation de paiement par IPN. La mise en oeuvre de votre commande interviendra dès l\'activation de la simulation d\'IPN.</p>
