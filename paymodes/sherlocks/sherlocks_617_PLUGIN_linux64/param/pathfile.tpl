...
# ------------------------------------------------------------------------
#
D_LOGO!/local/shop/paymodes/sherlocks/sherlocks_617_PLUGIN_linux64/logo/!
#
# --------------------------------------------------------------------------
...
#
F_DEFAULT!<%%DIRROOT%%>/local/shop/paymodes/sherlocks/sherlocks_617_PLUGIN_linux64/param/parmcom.sherlocks!
#
# fichier paramètre commercant
#
F_PARAM!<%%DIRROOT%%>/local/shop/paymodes/sherlocks/sherlocks_617_PLUGIN_linux64/param/parmcom!
#
# certificat du commercant
#
F_CERTIFICATE!<%%DIRROOT%%>/local/shop/paymodes/sherlocks/sherlocks_617_PLUGIN_linux64/param/certif!
# 
# type du certificat 	
# 
F_CTYPE!php!
