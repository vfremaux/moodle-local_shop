...
/**
 * Process endpoint. Possibly unconnected action.
 *
...
$PAGE->set_url(new moodle_url('/local/shop/paymodes/sherlocks/process.php'));
...
if (!empty($config->test)) {
    ...
    $ipnurl = new moodle_url('/local/shop/paymodes/sherlocks/sherlocks_ipn.php');
    ...
    echo '<input type="submit" name="GoTest" value="'.get_string('gotestipn', 'shoppaymodes_sherlocks').'" />';
    echo '</form />';
}
