...
# ------------------------------------------------------------------------
#
D_LOGO!/blocks/shop/paymodes/mercanet/mercanet_615_PLUGIN_linux32/logo/!
#
# --------------------------------------------------------------------------
...
#
F_DEFAULT!<%%DIRROOT%%>/blocks/shop/paymodes/mercanet/mercanet_615_PLUGIN_linux32/param/parmcom.mercanet!
#
# fichier paramètre commercant
#
F_PARAM!<%%DIRROOT%%>/blocks/shop/paymodes/mercanet/mercanet_615_PLUGIN_linux32/param/parmcom!
#
# certificat du commercant
#
F_CERTIFICATE!<%%DIRROOT%%>/blocks/shop/paymodes/mercanet/mercanet_615_PLUGIN_linux32/param/certif!
# 
# type du certificat 	
# 
F_CTYPE!php!
