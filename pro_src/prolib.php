...
final class pro_manager extends \local_vfcore\license_manager {
    ...
    const TRACE_DEBUG = 5;
    const TRACE_DEBUG_FINE = 10;

    public static $shortcomponent = 'local_shop';
    public static $component = 'local_shop';
    public static $componentpath = 'local/shop';
    public static $componentsettings = 'localsettingshop';

    // No more changes beyond this line.
